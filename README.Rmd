...
- [`R/`](https://github.com/LimaRAF/cursoR/tree/master/R):
...
Launch the [`make.R`](https://github.com/LimaRAF/cursoR/tree/master/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/LimaRAF/cursoR/blob/main/CONTRIBUTING.md).
